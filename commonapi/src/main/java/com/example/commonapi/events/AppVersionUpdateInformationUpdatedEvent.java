...
/**
 * An Axon event which will be published over event bus when updateInformation
 * of an existing version of app/library is updated.
 *
 */
@Value
@ToString(includeFieldNames = true)
@Revision("1.0")
public final class AppVersionUpdateInformationUpdatedEvent {
