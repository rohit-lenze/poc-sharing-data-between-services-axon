...
public final class AddAppVersionCommand {
    ...
    public static class AddAppVersionCommandBuilder {
        private AddAppVersionCommandBuilder() {
        }
    }

    public static AddAppVersionCommandBuilder builder(AppId id, AppVersionId versionId, AppVersionNumber versionNumber,
            AppBinaryName binaryName, LocalDate createdOn, DeveloperId developerId) {
        return new AddAppVersionCommandBuilder().id(id).versionId(versionId).versionNumber(versionNumber).binaryName(binaryName)
