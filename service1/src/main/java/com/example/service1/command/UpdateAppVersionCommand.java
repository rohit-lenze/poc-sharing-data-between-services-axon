...
public final class UpdateAppVersionCommand {
    ...
    public static class UpdateAppVersionCommandBuilder {
        private UpdateAppVersionCommandBuilder() {
        }
    }

    public static UpdateAppVersionCommandBuilder builder(AppId id, AppVersionId versionId, AppVersionNumber versionNumber,
            AppBinaryName binaryName) {
        return new UpdateAppVersionCommandBuilder().id(id).versionId(versionId).versionNumber(versionNumber)
